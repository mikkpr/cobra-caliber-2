...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create() {
      ...
      (0, _utils.enableMusicForState)('ambient', this);
...
var _Obstacle = __webpack_require__(/*! ../sprites/Obstacle */ 90);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    key: 'create',
    value: function create() {
      (0, _utils.enableMusicForState)('bigbeat', this);
      this.game.world.enableBody = true;
      this.game.physics.startSystem(_phaser2.default.Physics.ARCADE);
      this.game.curve.setPoints([50, 0, 0, 0, 50]);
      ...
      this.obstacle = new _Obstacle2.default(this.game, this.player, 300, this.game.world.centerY, 142);
